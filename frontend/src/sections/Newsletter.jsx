  ...
  return (
    <section className="py-12 lg:py-16 bg-gray-900">
      <div className="container-custom">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-brand/20 text-brand rounded-full text-xs font-medium mb-4">
          ...
          <p className="text-gray-400 mb-8 leading-relaxed">
            Subscribe to our health newsletter for medicine reminders, wellness tips, 
