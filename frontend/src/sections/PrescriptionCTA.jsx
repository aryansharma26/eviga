...
const PrescriptionCTA = () => {
  return (
    <section className="py-12 lg:py-16 bg-gradient-to-br from-brand-light to-primary-50">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3">
                <button className="w-full sm:w-auto px-6 py-3 bg-brand hover:bg-brand-dark text-white font-semibold rounded-xl transition-colors flex items-center justify-center gap-2">
                  <Upload className="w-5 h-5" />
                  Upload Prescription
                </button>
                <button className="w-full sm:w-auto px-6 py-3 bg-white border-2 border-gray-200 hover:border-brand text-gray-700 hover:text-brand font-semibold rounded-xl transition-colors flex items-center justify-center gap-2">
            ...
            <div className="hidden lg:flex items-center justify-center">
              <div className="relative">
                <div className="w-64 h-64 bg-gradient-to-br from-brand/10 to-primary-100 rounded-3xl flex items-center justify-center">
