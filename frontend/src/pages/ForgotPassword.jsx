        ...
        <div className="bg-white rounded-2xl shadow-sm p-8">
          {sent ? (
            <div className="text-center">
              ...
              <p className="text-gray-500">We've sent a password reset link to your email address.</p>
              <Link to="/login" className="inline-block mt-6 text-[#1a4d3a] font-medium hover:underline">Back to Login</Link>
            </div>
          ) : (
            <>
